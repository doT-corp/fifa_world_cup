...
button{
    ...
    <body>
        ...
        <div style="overflow-x:auto;" class="divs">
            <table id="list-groups" class="center">
                <tr>
                    <th>ID</th>
                    <th>Descrição</th>
                </tr>
    ...
    <script type="text/javascript">
        ...
        function search() {
            ...
            myList = document.getElementById("list-groups");
            ...
            counter.innerHTML = "Número de grupos encontrados: " + (n_encontrados - 1);
        }
